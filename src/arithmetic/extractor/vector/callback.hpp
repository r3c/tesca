...
namespace Tesca
{
	namespace Arithmetic
	{
		...
		{
			public:
				typedef std::function<Storage::Variant (Storage::Variant const*, Glay::Int32u)> Callback;

				CallbackVectorExtractor (const std::vector<Extractor const*>&, const std::string&, Callback);
